...
async def transcript_audio_file(api_key, file):
    """Asynchronous function to transcribe an audio file using the OpenAI API."""
...
async def process_text(api_key, system_prompt, user_prompt):
    """Asynchronous function to process text using the chat model."""
